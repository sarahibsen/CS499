...
class CustomTable(tk.Frame): # changed to handle the embedded in the GUI
      ...
      #  self.mainloop()
        ...
        def get_table_data(self):
                """
                Retrieves all the data from the current table.
                Returns:
                        list: List of rows containing cell data from the table.
                """
                data = []
